...
![image.png](/images/002-ii-level-1-notion-to-md/10-788058-image.png)


![image.png](/images/002-ii-level-1-notion-to-md/10-845137-image.png)


On the new tab, we will click “Request temporary access…” to allow us to use this free CORS Proxy.


![image.png](/images/002-ii-level-1-notion-to-md/10-921236-image.png)
...
5. The only time we use this **CORS Proxy** is when we **click “Convert”** to get Notion page information, **no any other features/actions will use this CORS Proxy.**
	...
	![image.png](/images/002-ii-level-1-notion-to-md/10-266295-image.png)
